...
// Only run spin wheel code if we're on the spin wheel page
const wheel = document.getElementById("wheel");
const spinBtn = document.getElementById("spin-btn");
const finalValue = document.getElementById("final-value");

if (wheel && spinBtn && finalValue) {
...
// Only run claw machine code if we're on the claw machine page
if (document.querySelector('.claw-machine')) {
  const elements = {
